...
`)}function $S(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ps).join(`
`)}function jS(i){let e=[];for(let t in i){let n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function ZS(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),o=r.name,a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Ps(i){return i!==""}function Yf(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function $f(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var KS=/^[ \t]*#include +<([\w\d./]+)>/gm;function ql(i){return i.replace(KS,QS)}var JS=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function QS(i,e){let t=ze[e];if(t===void 0){let n=JS.get(e);if(n!==void 0)t=ze[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ql(t)}var eM=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function jf(i){return i.replace(eM,tM)}function tM(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Zf(i){let e=`precision ${i.precision} float;
...
}`;function SM(i,e,t){let n=new Hr,s=new Ve,r=new Ve,o=new it,a=new jl({depthPacking:dv}),c=new Zl,l={},u=t.maxTextureSize,h={[Un]:Gt,[Gt]:Un,[bn]:bn},d=new Fn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ve},radius:{value:4}},vertexShader:yM,fragmentShader:xM}),m=d.clone();m.defines.HORIZONTAL_PASS=1;let g=new fn;g.setAttribute("position",new Mt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let v=new Rt(g,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=yp;let f=this.type;this.render=function(R,T,H){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||R.length===0)return;let ne=i.getRenderTarget(),y=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),G=i.state;G.setBlending(ui),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);let J=f!==qn&&this.type===qn,I=f===qn&&this.type!==qn;for(let k=0,B=R.length;k<B;k++){let q=R[k],V=q.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",q,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);let W=V.getFrameExtents();if(s.multiply(W),r.copy(V.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/W.x),s.x=r.x*W.x,V.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/W.y),s.y=r.y*W.y,V.mapSize.y=r.y)),V.map===null||J===!0||I===!0){let Q=this.type!==qn?{minFilter:St,magFilter:St}:{};V.map!==null&&V.map.dispose(),V.map=new jn(s.x,s.y,Q),V.map.texture.name=q.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();let X=V.getViewportCount();for(let Q=0;Q<X;Q++){let se=V.getViewport(Q);o.set(r.x*se.x,r.y*se.y,r.x*se.z,r.y*se.w),G.viewport(o),V.updateMatrices(q,Q),n=V.getFrustum(),b(T,H,V.camera,q,this.type)}V.isPointLightShadow!==!0&&this.type===qn&&A(V,H),V.needsUpdate=!1}f=this.type,p.needsUpdate=!1,i.setRenderTarget(ne,y,w)};function A(R,T){let H=e.update(v);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new jn(s.x,s.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(T,null,H,d,v,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(T,null,H,m,v,null)}function x(R,T,H,ne){let y=null,w=H.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(w!==void 0)y=w;else if(y=H.isPointLight===!0?c:a,i.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0){let G=y.uuid,J=T.uuid,I=l[G];I===void 0&&(I={},l[G]=I);let k=I[J];k===void 0&&(k=y.clone(),I[J]=k,T.addEventListener("dispose",P)),y=k}if(y.visible=T.visible,y.wireframe=T.wireframe,ne===qn?y.side=T.shadowSide!==null?T.shadowSide:T.side:y.side=T.shadowSide!==null?T.shadowSide:h[T.side],y.alphaMap=T.alphaMap,y.alphaTest=T.alphaTest,y.map=T.map,y.clipShadows=T.clipShadows,y.clippingPlanes=T.clippingPlanes,y.clipIntersection=T.clipIntersection,y.displacementMap=T.displacementMap,y.displacementScale=T.displacementScale,y.displacementBias=T.displacementBias,y.wireframeLinewidth=T.wireframeLinewidth,y.linewidth=T.linewidth,H.isPointLight===!0&&y.isMeshDistanceMaterial===!0){let G=i.properties.get(y);G.light=H}return y}function b(R,T,H,ne,y){if(R.visible===!1)return;if(R.layers.test(T.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&y===qn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,R.matrixWorld);let J=e.update(R),I=R.material;if(Array.isArray(I)){let k=J.groups;for(let B=0,q=k.length;B<q;B++){let V=k[B],W=I[V.materialIndex];if(W&&W.visible){let X=x(R,W,ne,y);R.onBeforeShadow(i,R,T,H,J,X,V),i.renderBufferDirect(H,null,J,X,R,V),R.onAfterShadow(i,R,T,H,J,X,V)}}}else if(I.visible){let k=x(R,I,ne,y);R.onBeforeShadow(i,R,T,H,J,k,null),i.renderBufferDirect(H,null,J,k,R,null),R.onAfterShadow(i,R,T,H,J,k,null)}}let G=R.children;for(let J=0,I=G.length;J<I;J++)b(G[J],T,H,ne,y)}function P(R){R.target.removeEventListener("dispose",P);for(let H in l){let ne=l[H],y=R.target.uuid;y in ne&&(ne[y].dispose(),delete ne[y])}}}function MM(i,e,t){let n=t.isWebGL2;function s(){let E=!1,ee=new it,te=null,ue=new it(0,0,0,0);return{setMask:function(Se){te!==Se&&!E&&(i.colorMask(Se,Se,Se,Se),te=Se)},setLocked:function(Se){E=Se},setClear:function(Se,Qe,st,Pt,Kt){Kt===!0&&(Se*=Pt,Qe*=Pt,st*=Pt),ee.set(Se,Qe,st,Pt),ue.equals(ee)===!1&&(i.clearColor(Se,Qe,st,Pt),ue.copy(ee))},reset:function(){E=!1,te=null,ue.set(-1,0,0,0)}}}function r(){let E=!1,ee=null,te=null,ue=null;return{setTest:function(Se){Se?he(i.DEPTH_TEST):je(i.DEPTH_TEST)},setMask:function(Se){ee!==Se&&!E&&(i.depthMask(Se),ee=Se)},setFunc:function(Se){if(te!==Se){switch(Se){case k0:i.depthFunc(i.NEVER);break;case H0:i.depthFunc(i.ALWAYS);break;case V0:i.depthFunc(i.LESS);break;case ta:i.depthFunc(i.LEQUAL);break;case G0:i.depthFunc(i.EQUAL);break;case W0:i.depthFunc(i.GEQUAL);break;case X0:i.depthFunc(i.GREATER);break;case q0:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}te=Se}},setLocked:function(Se){E=Se},setClear:function(Se){ue!==Se&&(i.clearDepth(Se),ue=Se)},reset:function(){E=!1,ee=null,te=null,ue=null}}}function o(){let E=!1,ee=null,te=null,ue=null,Se=null,Qe=null,st=null,Pt=null,Kt=null;return{setTest:function(rt){E||(rt?he(i.STENCIL_TEST):je(i.STENCIL_TEST))},setMask:function(rt){ee!==rt&&!E&&(i.stencilMask(rt),ee=rt)},setFunc:function(rt,zt,Tn){(te!==rt||ue!==zt||Se!==Tn)&&(i.stencilFunc(rt,zt,Tn),te=rt,ue=zt,Se=Tn)},setOp:function(rt,zt,Tn){(Qe!==rt||st!==zt||Pt!==Tn)&&(i.stencilOp(rt,zt,Tn),Qe=rt,st=zt,Pt=Tn)},setLocked:function(rt){E=rt},setClear:function(rt){Kt!==rt&&(i.clearStencil(rt),Kt=rt)},reset:function(){E=!1,ee=null,te=null,ue=null,Se=null,Qe=null,st=null,Pt=null,Kt=null}}}let a=new s,c=new r,l=new o,u=new WeakMap,h=new WeakMap,d={},m={},g=new WeakMap,v=[],p=null,f=!1,A=null,x=null,b=null,P=null,R=null,T=null,H=null,ne=new _e(0,0,0),y=0,w=!1,G=null,J=null,I=null,k=null,B=null,q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),V=!1,W=0,X=i.getParameter(i.VERSION);X.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(X)[1]),V=W>=1):X.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),V=W>=2);let Q=null,se={},Re=i.getParameter(i.SCISSOR_BOX),z=i.getParameter(i.VIEWPORT),j=new it().fromArray(Re),ae=new it().fromArray(z);function Me(E,ee,te,ue){let Se=new Uint8Array(4),Qe=i.createTexture();i.bindTexture(E,Qe),i.texParameteri(E,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(E,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let st=0;st<te;st++)n&&(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)?i.texImage3D(ee,0,i.RGBA,1,1,ue,0,i.RGBA,i.UNSIGNED_BYTE,Se):i.texImage2D(ee+st,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Se);return Qe}let Ae={};Ae[i.TEXTURE_2D]=Me(i.TEXTURE_2D,i.TEXTURE_2D,1),Ae[i.TEXTURE_CUBE_MAP]=Me(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(Ae[i.TEXTURE_2D_ARRAY]=Me(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Ae[i.TEXTURE_3D]=Me(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),c.setClear(1),l.setClear(0),he(i.DEPTH_TEST),c.setFunc(ta),Fe(!1),M(Cd),he(i.CULL_FACE),ge(ui);function he(E){d[E]!==!0&&(i.enable(E),d[E]=!0)}function je(E){d[E]!==!1&&(i.disable(E),d[E]=!1)}function Le(E,ee){return m[E]!==ee?(i.bindFramebuffer(E,ee),m[E]=ee,n&&(E===i.DRAW_FRAMEBUFFER&&(m[i.FRAMEBUFFER]=ee),E===i.FRAMEBUFFER&&(m[i.DRAW_FRAMEBUFFER]=ee)),!0):!1}function D(E,ee){let te=v,ue=!1;if(E)if(te=g.get(ee),te===void 0&&(te=[],g.set(ee,te)),E.isWebGLMultipleRenderTargets){let Se=E.texture;if(te.length!==Se.length||te[0]!==i.COLOR_ATTACHMENT0){for(let Qe=0,st=Se.length;Qe<st;Qe++)te[Qe]=i.COLOR_ATTACHMENT0+Qe;te.length=Se.length,ue=!0}}else te[0]!==i.COLOR_ATTACHMENT0&&(te[0]=i.COLOR_ATTACHMENT0,ue=!0);else te[0]!==i.BACK&&(te[0]=i.BACK,ue=!0);ue&&(t.isWebGL2?i.drawBuffers(te):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(te))}function Ct(E){return p!==E?(i.useProgram(E),p=E,!0):!1}let xe={[Bi]:i.FUNC_ADD,[E0]:i.FUNC_SUBTRACT,[w0]:i.FUNC_REVERSE_SUBTRACT};if(n)xe[Dd]=i.MIN,xe[Nd]=i.MAX;else{let E=e.get("EXT_blend_minmax");E!==null&&(xe[Dd]=E.MIN_EXT,xe[Nd]=E.MAX_EXT)}let Ce={[T0]:i.ZERO,[R0]:i.ONE,[C0]:i.SRC_COLOR,[Ll]:i.SRC_ALPHA,[U0]:i.SRC_ALPHA_SATURATE,[D0]:i.DST_COLOR,[I0]:i.DST_ALPHA,[P0]:i.ONE_MINUS_SRC_COLOR,[Dl]:i.ONE_MINUS_SRC_ALPHA,[N0]:i.ONE_MINUS_DST_COLOR,[L0]:i.ONE_MINUS_DST_ALPHA,[O0]:i.CONSTANT_COLOR,[F0]:i.ONE_MINUS_CONSTANT_COLOR,[B0]:i.CONSTANT_ALPHA,[z0]:i.ONE_MINUS_CONSTANT_ALPHA};function ge(E,ee,te,ue,Se,Qe,st,Pt,Kt,rt){if(E===ui){f===!0&&(je(i.BLEND),f=!1);return}if(f===!1&&(he(i.BLEND),f=!0),E!==A0){if(E!==A||rt!==w){if((x!==Bi||R!==Bi)&&(i.blendEquation(i.FUNC_ADD),x=Bi,R=Bi),rt)switch(E){case Is:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Pd:i.blendFunc(i.ONE,i.ONE);break;case Id:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ld:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",E);break}else switch(E){case Is:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Pd:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Id:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ld:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",E);break}b=null,P=null,T=null,H=null,ne.set(0,0,0),y=0,A=E,w=rt}return}Se=Se||ee,Qe=Qe||te,st=st||ue,(ee!==x||Se!==R)&&(i.blendEquationSeparate(xe[ee],xe[Se]),x=ee,R=Se),(te!==b||ue!==P||Qe!==T||st!==H)&&(i.blendFuncSeparate(Ce[te],Ce[ue],Ce[Qe],Ce[st]),b=te,P=ue,T=Qe,H=st),(Pt.equals(ne)===!1||Kt!==y)&&(i.blendColor(Pt.r,Pt.g,Pt.b,Kt),ne.copy(Pt),y=Kt),A=E,w=!1}function ut(E,ee){E.side===bn?je(i.CULL_FACE):he(i.CULL_FACE);let te=E.side===Gt;ee&&(te=!te),Fe(te),E.blending===Is&&E.transparent===!1?ge(ui):ge(E.blending,E.blendEquation,E.blendSrc,E.blendDst,E.blendEquationAlpha,E.blendSrcAlpha,E.blendDstAlpha,E.blendColor,E.blendAlpha,E.premultipliedAlpha),c.setFunc(E.depthFunc),c.setTest(E.depthTest),c.setMask(E.depthWrite),a.setMask(E.colorWrite);let ue=E.stencilWrite;l.setTest(ue),ue&&(l.setMask(E.stencilWriteMask),l.setFunc(E.stencilFunc,E.stencilRef,E.stencilFuncMask),l.setOp(E.stencilFail,E.stencilZFail,E.stencilZPass)),N(E.polygonOffset,E.polygonOffsetFactor,E.polygonOffsetUnits),E.alphaToCoverage===!0?he(i.SAMPLE_ALPHA_TO_COVERAGE):je(i.SAMPLE_ALPHA_TO_COVERAGE)}function Fe(E){G!==E&&(E?i.frontFace(i.CW):i.frontFace(i.CCW),G=E)}function M(E){E!==S0?(he(i.CULL_FACE),E!==J&&(E===Cd?i.cullFace(i.BACK):E===M0?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):je(i.CULL_FACE),J=E}function _(E){E!==I&&(V&&i.lineWidth(E),I=E)}function N(E,ee,te){E?(he(i.POLYGON_OFFSET_FILL),(k!==ee||B!==te)&&(i.polygonOffset(ee,te),k=ee,B=te)):je(i.POLYGON_OFFSET_FILL)}function K(E){E?he(i.SCISSOR_TEST):je(i.SCISSOR_TEST)}function Y(E){E===void 0&&(E=i.TEXTURE0+q-1),Q!==E&&(i.activeTexture(E),Q=E)}function Z(E,ee,te){te===void 0&&(Q===null?te=i.TEXTURE0+q-1:te=Q);let ue=se[te];ue===void 0&&(ue={type:void 0,texture:void 0},se[te]=ue),(ue.type!==E||ue.texture!==ee)&&(Q!==te&&(i.activeTexture(te),Q=te),i.bindTexture(E,ee||Ae[E]),ue.type=E,ue.texture=ee)}function de(){let E=se[Q];E!==void 0&&E.type!==void 0&&(i.bindTexture(E.type,null),E.type=void 0,E.texture=void 0)}function re(){try{i.compressedTexImage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function ce(){try{i.compressedTexImage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function we(){try{i.texSubImage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function ke(){try{i.texSubImage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function $(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function tt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function qe(){try{i.texStorage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function Pe(){try{i.texStorage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function ye(){try{i.texImage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function le(){try{i.texImage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function Be(E){j.equals(E)===!1&&(i.scissor(E.x,E.y,E.z,E.w),j.copy(E))}function Je(E){ae.equals(E)===!1&&(i.viewport(E.x,E.y,E.z,E.w),ae.copy(E))}function ot(E,ee){let te=h.get(ee);te===void 0&&(te=new WeakMap,h.set(ee,te));let ue=te.get(E);ue===void 0&&(ue=i.getUniformBlockIndex(ee,E.name),te.set(E,ue))}function Ye(E,ee){let ue=h.get(ee).get(E);u.get(ee)!==ue&&(i.uniformBlockBinding(ee,ue,E.__bindingPointIndex),u.set(ee,ue))}function nt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),n===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),d={},Q=null,se={},m={},g=new WeakMap,v=[],p=null,f=!1,A=null,x=null,b=null,P=null,R=null,T=null,H=null,ne=new _e(0,0,0),y=0,w=!1,G=null,J=null,I=null,k=null,B=null,j.set(0,0,i.canvas.width,i.canvas.height),ae.set(0,0,i.canvas.width,i.canvas.height),a.reset(),c.reset(),l.reset()}return{buffers:{color:a,depth:c,stencil:l},enable:he,disable:je,bindFramebuffer:Le,drawBuffers:D,useProgram:Ct,setBlending:ge,setMaterial:ut,setFlipSided:Fe,setCullFace:M,setLineWidth:_,setPolygonOffset:N,setScissorTest:K,activeTexture:Y,bindTexture:Z,unbindTexture:de,compressedTexImage2D:re,compressedTexImage3D:ce,texImage2D:ye,texImage3D:le,updateUBOMapping:ot,uniformBlockBinding:Ye,texStorage2D:qe,texStorage3D:Pe,texSubImage2D:we,texSubImage3D:ke,compressedTexSubImage2D:$,compressedTexSubImage3D:tt,scissor:Be,viewport:Je,reset:nt}}function bM(i,e,t,n,s,r,o){let a=s.isWebGL2,c=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new WeakMap,h,d=new WeakMap,m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(M,_){return m?new OffscreenCanvas(M,_):kr("canvas")}function v(M,_,N,K){let Y=1;if((M.width>K||M.height>K)&&(Y=K/Math.max(M.width,M.height)),Y<1||_===!0)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap){let Z=_?aa:Math.floor,de=Z(Y*M.width),re=Z(Y*M.height);h===void 0&&(h=g(de,re));let ce=N?g(de,re):h;return ce.width=de,ce.height=re,ce.getContext("2d").drawImage(M,0,0,de,re),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+M.width+"x"+M.height+") to ("+de+"x"+re+")."),ce}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+M.width+"x"+M.height+")."),M;return M}function p(M){return Bl(M.width)&&Bl(M.height)}function f(M){return a?!1:M.wrapS!==jt||M.wrapT!==jt||M.minFilter!==St&&M.minFilter!==Dt}function A(M,_){return M.generateMipmaps&&_&&M.minFilter!==St&&M.minFilter!==Dt}function x(M){i.generateMipmap(M)}function b(M,_,N,K,Y=!1){if(a===!1)return _;if(M!==null){if(i[M]!==void 0)return i[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let Z=_;if(_===i.RED&&(N===i.FLOAT&&(Z=i.R32F),N===i.HALF_FLOAT&&(Z=i.R16F),N===i.UNSIGNED_BYTE&&(Z=i.R8)),_===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(Z=i.R8UI),N===i.UNSIGNED_SHORT&&(Z=i.R16UI),N===i.UNSIGNED_INT&&(Z=i.R32UI),N===i.BYTE&&(Z=i.R8I),N===i.SHORT&&(Z=i.R16I),N===i.INT&&(Z=i.R32I)),_===i.RG&&(N===i.FLOAT&&(Z=i.RG32F),N===i.HALF_FLOAT&&(Z=i.RG16F),N===i.UNSIGNED_BYTE&&(Z=i.RG8)),_===i.RGBA){let de=Y?ia:Ze.getTransfer(K);N===i.FLOAT&&(Z=i.RGBA32F),N===i.HALF_FLOAT&&(Z=i.RGBA16F),N===i.UNSIGNED_BYTE&&(Z=de===ct?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(Z=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(Z=i.RGB5_A1)}return(Z===i.R16F||Z===i.R32F||Z===i.RG16F||Z===i.RG32F||Z===i.RGBA16F||Z===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function P(M,_,N){return A(M,N)===!0||M.isFramebufferTexture&&M.minFilter!==St&&M.minFilter!==Dt?Math.log2(Math.max(_.width,_.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?_.mipmaps.length:1}function R(M){return M===St||M===na||M===zi?i.NEAREST:i.LINEAR}function T(M){let _=M.target;_.removeEventListener("dispose",T),ne(_),_.isVideoTexture&&u.delete(_)}function H(M){let _=M.target;_.removeEventListener("dispose",H),w(_)}function ne(M){let _=n.get(M);if(_.__webglInit===void 0)return;let N=M.source,K=d.get(N);if(K){let Y=K[_.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&y(M),Object.keys(K).length===0&&d.delete(N)}n.remove(M)}function y(M){let _=n.get(M);i.deleteTexture(_.__webglTexture);let N=M.source,K=d.get(N);delete K[_.__cacheKey],o.memory.textures--}function w(M){let _=M.texture,N=n.get(M),K=n.get(_);if(K.__webglTexture!==void 0&&(i.deleteTexture(K.__webglTexture),o.memory.textures--),M.depthTexture&&M.depthTexture.dispose(),M.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(N.__webglFramebuffer[Y]))for(let Z=0;Z<N.__webglFramebuffer[Y].length;Z++)i.deleteFramebuffer(N.__webglFramebuffer[Y][Z]);else i.deleteFramebuffer(N.__webglFramebuffer[Y]);N.__webglDepthbuffer&&i.deleteRenderbuffer(N.__webglDepthbuffer[Y])}else{if(Array.isArray(N.__webglFramebuffer))for(let Y=0;Y<N.__webglFramebuffer.length;Y++)i.deleteFramebuffer(N.__webglFramebuffer[Y]);else i.deleteFramebuffer(N.__webglFramebuffer);if(N.__webglDepthbuffer&&i.deleteRenderbuffer(N.__webglDepthbuffer),N.__webglMultisampledFramebuffer&&i.deleteFramebuffer(N.__webglMultisampledFramebuffer),N.__webglColorRenderbuffer)for(let Y=0;Y<N.__webglColorRenderbuffer.length;Y++)N.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(N.__webglColorRenderbuffer[Y]);N.__webglDepthRenderbuffer&&i.deleteRenderbuffer(N.__webglDepthRenderbuffer)}if(M.isWebGLMultipleRenderTargets)for(let Y=0,Z=_.length;Y<Z;Y++){let de=n.get(_[Y]);de.__webglTexture&&(i.deleteTexture(de.__webglTexture),o.memory.textures--),n.remove(_[Y])}n.remove(_),n.remove(M)}let G=0;function J(){G=0}function I(){let M=G;return M>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+s.maxTextures),G+=1,M}function k(M){let _=[];return _.push(M.wrapS),_.push(M.wrapT),_.push(M.wrapR||0),_.push(M.magFilter),_.push(M.minFilter),_.push(M.anisotropy),_.push(M.internalFormat),_.push(M.format),_.push(M.type),_.push(M.generateMipmaps),_.push(M.premultiplyAlpha),_.push(M.flipY),_.push(M.unpackAlignment),_.push(M.colorSpace),_.join()}function B(M,_){let N=n.get(M);if(M.isVideoTexture&&ut(M),M.isRenderTargetTexture===!1&&M.version>0&&N.__version!==M.version){let K=M.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{j(N,M,_);return}}t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+_)}function q(M,_){let N=n.get(M);if(M.version>0&&N.__version!==M.version){j(N,M,_);return}t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+_)}function V(M,_){let N=n.get(M);if(M.version>0&&N.__version!==M.version){j(N,M,_);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+_)}function W(M,_){let N=n.get(M);if(M.version>0&&N.__version!==M.version){ae(N,M,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+_)}let X={[Xi]:i.REPEAT,[jt]:i.CLAMP_TO_EDGE,[Br]:i.MIRRORED_REPEAT},Q={[St]:i.NEAREST,[na]:i.NEAREST_MIPMAP_NEAREST,[zi]:i.NEAREST_MIPMAP_LINEAR,[Dt]:i.LINEAR,[Nr]:i.LINEAR_MIPMAP_NEAREST,[Dn]:i.LINEAR_MIPMAP_LINEAR},se={[pv]:i.NEVER,[xv]:i.ALWAYS,[mv]:i.LESS,[Cp]:i.LEQUAL,[gv]:i.EQUAL,[yv]:i.GEQUAL,[vv]:i.GREATER,[_v]:i.NOTEQUAL};function Re(M,_,N){if(_.type===Ln&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Dt||_.magFilter===Nr||_.magFilter===zi||_.magFilter===Dn||_.minFilter===Dt||_.minFilter===Nr||_.minFilter===zi||_.minFilter===Dn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),N?(i.texParameteri(M,i.TEXTURE_WRAP_S,X[_.wrapS]),i.texParameteri(M,i.TEXTURE_WRAP_T,X[_.wrapT]),(M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY)&&i.texParameteri(M,i.TEXTURE_WRAP_R,X[_.wrapR]),i.texParameteri(M,i.TEXTURE_MAG_FILTER,Q[_.magFilter]),i.texParameteri(M,i.TEXTURE_MIN_FILTER,Q[_.minFilter])):(i.texParameteri(M,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(M,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY)&&i.texParameteri(M,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(_.wrapS!==jt||_.wrapT!==jt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(M,i.TEXTURE_MAG_FILTER,R(_.magFilter)),i.texParameteri(M,i.TEXTURE_MIN_FILTER,R(_.minFilter)),_.minFilter!==St&&_.minFilter!==Dt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),_.compareFunction&&(i.texParameteri(M,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(M,i.TEXTURE_COMPARE_FUNC,se[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){let K=e.get("EXT_texture_filter_anisotropic");if(_.magFilter===St||_.minFilter!==zi&&_.minFilter!==Dn||_.type===Ln&&e.has("OES_texture_float_linear")===!1||a===!1&&_.type===zr&&e.has("OES_texture_half_float_linear")===!1)return;(_.anisotropy>1||n.get(_).__currentAnisotropy)&&(i.texParameterf(M,K.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy)}}function z(M,_){let N=!1;M.__webglInit===void 0&&(M.__webglInit=!0,_.addEventListener("dispose",T));let K=_.source,Y=d.get(K);Y===void 0&&(Y={},d.set(K,Y));let Z=k(_);if(Z!==M.__cacheKey){Y[Z]===void 0&&(Y[Z]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,N=!0),Y[Z].usedTimes++;let de=Y[M.__cacheKey];de!==void 0&&(Y[M.__cacheKey].usedTimes--,de.usedTimes===0&&y(_)),M.__cacheKey=Z,M.__webglTexture=Y[Z].texture}return N}function j(M,_,N){let K=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(K=i.TEXTURE_3D);let Y=z(M,_),Z=_.source;t.bindTexture(K,M.__webglTexture,i.TEXTURE0+N);let de=n.get(Z);if(Z.version!==de.__version||Y===!0){t.activeTexture(i.TEXTURE0+N);let re=Ze.getPrimaries(Ze.workingColorSpace),ce=_.colorSpace===un?null:Ze.getPrimaries(_.colorSpace),we=_.colorSpace===un||re===ce?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);let ke=f(_)&&p(_.image)===!1,$=v(_.image,ke,!1,s.maxTextureSize);$=Fe(_,$);let tt=p($)||a,qe=r.convert(_.format,_.colorSpace),Pe=r.convert(_.type),ye=b(_.internalFormat,qe,Pe,_.colorSpace,_.isVideoTexture);Re(K,_,tt);let le,Be=_.mipmaps,Je=a&&_.isVideoTexture!==!0&&ye!==wp,ot=de.__version===void 0||Y===!0,Ye=Z.dataReady,nt=P(_,$,tt);if(_.isDepthTexture)ye=i.DEPTH_COMPONENT,a?_.type===Ln?ye=i.DEPTH_COMPONENT32F:_.type===ci?ye=i.DEPTH_COMPONENT24:_.type===Hi?ye=i.DEPTH24_STENCIL8:ye=i.DEPTH_COMPONENT16:_.type===Ln&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),_.format===Vi&&ye===i.DEPTH_COMPONENT&&_.type!==gu&&_.type!==ci&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),_.type=ci,Pe=r.convert(_.type)),_.format===Os&&ye===i.DEPTH_COMPONENT&&(ye=i.DEPTH_STENCIL,_.type!==Hi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),_.type=Hi,Pe=r.convert(_.type))),ot&&(Je?t.texStorage2D(i.TEXTURE_2D,1,ye,$.width,$.height):t.texImage2D(i.TEXTURE_2D,0,ye,$.width,$.height,0,qe,Pe,null));else if(_.isDataTexture)if(Be.length>0&&tt){Je&&ot&&t.texStorage2D(i.TEXTURE_2D,nt,ye,Be[0].width,Be[0].height);for(let E=0,ee=Be.length;E<ee;E++)le=Be[E],Je?Ye&&t.texSubImage2D(i.TEXTURE_2D,E,0,0,le.width,le.height,qe,Pe,le.data):t.texImage2D(i.TEXTURE_2D,E,ye,le.width,le.height,0,qe,Pe,le.data);_.generateMipmaps=!1}else Je?(ot&&t.texStorage2D(i.TEXTURE_2D,nt,ye,$.width,$.height),Ye&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,$.width,$.height,qe,Pe,$.data)):t.texImage2D(i.TEXTURE_2D,0,ye,$.width,$.height,0,qe,Pe,$.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Je&&ot&&t.texStorage3D(i.TEXTURE_2D_ARRAY,nt,ye,Be[0].width,Be[0].height,$.depth);for(let E=0,ee=Be.length;E<ee;E++)le=Be[E],_.format!==ln?qe!==null?Je?Ye&&t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,E,0,0,0,le.width,le.height,$.depth,qe,le.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,E,ye,le.width,le.height,$.depth,0,le.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Je?Ye&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,E,0,0,0,le.width,le.height,$.depth,qe,Pe,le.data):t.texImage3D(i.TEXTURE_2D_ARRAY,E,ye,le.width,le.height,$.depth,0,qe,Pe,le.data)}else{Je&&ot&&t.texStorage2D(i.TEXTURE_2D,nt,ye,Be[0].width,Be[0].height);for(let E=0,ee=Be.length;E<ee;E++)le=Be[E],_.format!==ln?qe!==null?Je?Ye&&t.compressedTexSubImage2D(i.TEXTURE_2D,E,0,0,le.width,le.height,qe,le.data):t.compressedTexImage2D(i.TEXTURE_2D,E,ye,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Je?Ye&&t.texSubImage2D(i.TEXTURE_2D,E,0,0,le.width,le.height,qe,Pe,le.data):t.texImage2D(i.TEXTURE_2D,E,ye,le.width,le.height,0,qe,Pe,le.data)}else if(_.isDataArrayTexture)Je?(ot&&t.texStorage3D(i.TEXTURE_2D_ARRAY,nt,ye,$.width,$.height,$.depth),Ye&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,qe,Pe,$.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,ye,$.width,$.height,$.depth,0,qe,Pe,$.data);else if(_.isData3DTexture)Je?(ot&&t.texStorage3D(i.TEXTURE_3D,nt,ye,$.width,$.height,$.depth),Ye&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,qe,Pe,$.data)):t.texImage3D(i.TEXTURE_3D,0,ye,$.width,$.height,$.depth,0,qe,Pe,$.data);else if(_.isFramebufferTexture){if(ot)if(Je)t.texStorage2D(i.TEXTURE_2D,nt,ye,$.width,$.height);else{let E=$.width,ee=$.height;for(let te=0;te<nt;te++)t.texImage2D(i.TEXTURE_2D,te,ye,E,ee,0,qe,Pe,null),E>>=1,ee>>=1}}else if(Be.length>0&&tt){Je&&ot&&t.texStorage2D(i.TEXTURE_2D,nt,ye,Be[0].width,Be[0].height);for(let E=0,ee=Be.length;E<ee;E++)le=Be[E],Je?Ye&&t.texSubImage2D(i.TEXTURE_2D,E,0,0,qe,Pe,le):t.texImage2D(i.TEXTURE_2D,E,ye,qe,Pe,le);_.generateMipmaps=!1}else Je?(ot&&t.texStorage2D(i.TEXTURE_2D,nt,ye,$.width,$.height),Ye&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,qe,Pe,$)):t.texImage2D(i.TEXTURE_2D,0,ye,qe,Pe,$);A(_,tt)&&x(K),de.__version=Z.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function ae(M,_,N){if(_.image.length!==6)return;let K=z(M,_),Y=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,M.__webglTexture,i.TEXTURE0+N);let Z=n.get(Y);if(Y.version!==Z.__version||K===!0){t.activeTexture(i.TEXTURE0+N);let de=Ze.getPrimaries(Ze.workingColorSpace),re=_.colorSpace===un?null:Ze.getPrimaries(_.colorSpace),ce=_.colorSpace===un||de===re?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce);let we=_.isCompressedTexture||_.image[0].isCompressedTexture,ke=_.image[0]&&_.image[0].isDataTexture,$=[];for(let E=0;E<6;E++)!we&&!ke?$[E]=v(_.image[E],!1,!0,s.maxCubemapSize):$[E]=ke?_.image[E].image:_.image[E],$[E]=Fe(_,$[E]);let tt=$[0],qe=p(tt)||a,Pe=r.convert(_.format,_.colorSpace),ye=r.convert(_.type),le=b(_.internalFormat,Pe,ye,_.colorSpace),Be=a&&_.isVideoTexture!==!0,Je=Z.__version===void 0||K===!0,ot=Y.dataReady,Ye=P(_,tt,qe);Re(i.TEXTURE_CUBE_MAP,_,qe);let nt;if(we){Be&&Je&&t.texStorage2D(i.TEXTURE_CUBE_MAP,Ye,le,tt.width,tt.height);for(let E=0;E<6;E++){nt=$[E].mipmaps;for(let ee=0;ee<nt.length;ee++){let te=nt[ee];_.format!==ln?Pe!==null?Be?ot&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee,0,0,te.width,te.height,Pe,te.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee,le,te.width,te.height,0,te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Be?ot&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee,0,0,te.width,te.height,Pe,ye,te.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee,le,te.width,te.height,0,Pe,ye,te.data)}}}else{nt=_.mipmaps,Be&&Je&&(nt.length>0&&Ye++,t.texStorage2D(i.TEXTURE_CUBE_MAP,Ye,le,$[0].width,$[0].height));for(let E=0;E<6;E++)if(ke){Be?ot&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,0,0,$[E].width,$[E].height,Pe,ye,$[E].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,le,$[E].width,$[E].height,0,Pe,ye,$[E].data);for(let ee=0;ee<nt.length;ee++){let ue=nt[ee].image[E].image;Be?ot&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee+1,0,0,ue.width,ue.height,Pe,ye,ue.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee+1,le,ue.width,ue.height,0,Pe,ye,ue.data)}}else{Be?ot&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,0,0,Pe,ye,$[E]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,le,Pe,ye,$[E]);for(let ee=0;ee<nt.length;ee++){let te=nt[ee];Be?ot&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee+1,0,0,Pe,ye,te.image[E]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee+1,le,Pe,ye,te.image[E])}}}A(_,qe)&&x(i.TEXTURE_CUBE_MAP),Z.__version=Y.version,_.onUpdate&&_.onUpdate(_)}M.__version=_.version}function Me(M,_,N,K,Y,Z){let de=r.convert(N.format,N.colorSpace),re=r.convert(N.type),ce=b(N.internalFormat,de,re,N.colorSpace);if(!n.get(_).__hasExternalTextures){let ke=Math.max(1,_.width>>Z),$=Math.max(1,_.height>>Z);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?t.texImage3D(Y,Z,ce,ke,$,_.depth,0,de,re,null):t.texImage2D(Y,Z,ce,ke,$,0,de,re,null)}t.bindFramebuffer(i.FRAMEBUFFER,M),ge(_)?c.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Y,n.get(N).__webglTexture,0,Ce(_)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,Y,n.get(N).__webglTexture,Z),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ae(M,_,N){if(i.bindRenderbuffer(i.RENDERBUFFER,M),_.depthBuffer&&!_.stencilBuffer){let K=a===!0?i.DEPTH_COMPONENT24:i.DEPTH_COMPONENT16;if(N||ge(_)){let Y=_.depthTexture;Y&&Y.isDepthTexture&&(Y.type===Ln?K=i.DEPTH_COMPONENT32F:Y.type===ci&&(K=i.DEPTH_COMPONENT24));let Z=Ce(_);ge(_)?c.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Z,K,_.width,_.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,Z,K,_.width,_.height)}else i.renderbufferStorage(i.RENDERBUFFER,K,_.width,_.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,M)}else if(_.depthBuffer&&_.stencilBuffer){let K=Ce(_);N&&ge(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,K,i.DEPTH24_STENCIL8,_.width,_.height):ge(_)?c.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,K,i.DEPTH24_STENCIL8,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,M)}else{let K=_.isWebGLMultipleRenderTargets===!0?_.texture:[_.texture];for(let Y=0;Y<K.length;Y++){let Z=K[Y],de=r.convert(Z.format,Z.colorSpace),re=r.convert(Z.type),ce=b(Z.internalFormat,de,re,Z.colorSpace),we=Ce(_);N&&ge(_)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,we,ce,_.width,_.height):ge(_)?c.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,we,ce,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ce,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function he(M,_){if(_&&_.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,M),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(_.depthTexture).__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),B(_.depthTexture,0);let K=n.get(_.depthTexture).__webglTexture,Y=Ce(_);if(_.depthTexture.format===Vi)ge(_)?c.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,K,0);else if(_.depthTexture.format===Os)ge(_)?c.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0,Y):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,K,0);else throw new Error("Unknown depthTexture format")}function je(M){let _=n.get(M),N=M.isWebGLCubeRenderTarget===!0;if(M.depthTexture&&!_.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");he(_.__webglFramebuffer,M)}else if(N){_.__webglDepthbuffer=[];for(let K=0;K<6;K++)t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[K]),_.__webglDepthbuffer[K]=i.createRenderbuffer(),Ae(_.__webglDepthbuffer[K],M,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer=i.createRenderbuffer(),Ae(_.__webglDepthbuffer,M,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Le(M,_,N){let K=n.get(M);_!==void 0&&Me(K.__webglFramebuffer,M,M.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&je(M)}function D(M){let _=M.texture,N=n.get(M),K=n.get(_);M.addEventListener("dispose",H),M.isWebGLMultipleRenderTargets!==!0&&(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=_.version,o.memory.textures++);let Y=M.isWebGLCubeRenderTarget===!0,Z=M.isWebGLMultipleRenderTargets===!0,de=p(M)||a;if(Y){N.__webglFramebuffer=[];for(let re=0;re<6;re++)if(a&&_.mipmaps&&_.mipmaps.length>0){N.__webglFramebuffer[re]=[];for(let ce=0;ce<_.mipmaps.length;ce++)N.__webglFramebuffer[re][ce]=i.createFramebuffer()}else N.__webglFramebuffer[re]=i.createFramebuffer()}else{if(a&&_.mipmaps&&_.mipmaps.length>0){N.__webglFramebuffer=[];for(let re=0;re<_.mipmaps.length;re++)N.__webglFramebuffer[re]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(Z)if(s.drawBuffers){let re=M.texture;for(let ce=0,we=re.length;ce<we;ce++){let ke=n.get(re[ce]);ke.__webglTexture===void 0&&(ke.__webglTexture=i.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&M.samples>0&&ge(M)===!1){let re=Z?_:[_];N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let ce=0;ce<re.length;ce++){let we=re[ce];N.__webglColorRenderbuffer[ce]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[ce]);let ke=r.convert(we.format,we.colorSpace),$=r.convert(we.type),tt=b(we.internalFormat,ke,$,we.colorSpace,M.isXRRenderTarget===!0),qe=Ce(M);i.renderbufferStorageMultisample(i.RENDERBUFFER,qe,tt,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,N.__webglColorRenderbuffer[ce])}i.bindRenderbuffer(i.RENDERBUFFER,null),M.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),Ae(N.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(Y){t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),Re(i.TEXTURE_CUBE_MAP,_,de);for(let re=0;re<6;re++)if(a&&_.mipmaps&&_.mipmaps.length>0)for(let ce=0;ce<_.mipmaps.length;ce++)Me(N.__webglFramebuffer[re][ce],M,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+re,ce);else Me(N.__webglFramebuffer[re],M,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);A(_,de)&&x(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Z){let re=M.texture;for(let ce=0,we=re.length;ce<we;ce++){let ke=re[ce],$=n.get(ke);t.bindTexture(i.TEXTURE_2D,$.__webglTexture),Re(i.TEXTURE_2D,ke,de),Me(N.__webglFramebuffer,M,ke,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,0),A(ke,de)&&x(i.TEXTURE_2D)}t.unbindTexture()}else{let re=i.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(a?re=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(re,K.__webglTexture),Re(re,_,de),a&&_.mipmaps&&_.mipmaps.length>0)for(let ce=0;ce<_.mipmaps.length;ce++)Me(N.__webglFramebuffer[ce],M,_,i.COLOR_ATTACHMENT0,re,ce);else Me(N.__webglFramebuffer,M,_,i.COLOR_ATTACHMENT0,re,0);A(_,de)&&x(re),t.unbindTexture()}M.depthBuffer&&je(M)}function Ct(M){let _=p(M)||a,N=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let K=0,Y=N.length;K<Y;K++){let Z=N[K];if(A(Z,_)){let de=M.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,re=n.get(Z).__webglTexture;t.bindTexture(de,re),x(de),t.unbindTexture()}}}function xe(M){if(a&&M.samples>0&&ge(M)===!1){let _=M.isWebGLMultipleRenderTargets?M.texture:[M.texture],N=M.width,K=M.height,Y=i.COLOR_BUFFER_BIT,Z=[],de=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=n.get(M),ce=M.isWebGLMultipleRenderTargets===!0;if(ce)for(let we=0;we<_.length;we++)t.bindFramebuffer(i.FRAMEBUFFER,re.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,re.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,re.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,re.__webglFramebuffer);for(let we=0;we<_.length;we++){Z.push(i.COLOR_ATTACHMENT0+we),M.depthBuffer&&Z.push(de);let ke=re.__ignoreDepthValues!==void 0?re.__ignoreDepthValues:!1;if(ke===!1&&(M.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),M.stencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),ce&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,re.__webglColorRenderbuffer[we]),ke===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[de]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[de])),ce){let $=n.get(_[we]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,$,0)}i.blitFramebuffer(0,0,N,K,0,0,N,K,Y,i.NEAREST),l&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Z)}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ce)for(let we=0;we<_.length;we++){t.bindFramebuffer(i.FRAMEBUFFER,re.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,re.__webglColorRenderbuffer[we]);let ke=n.get(_[we]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,re.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,ke,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,re.__webglMultisampledFramebuffer)}}function Ce(M){return Math.min(s.maxSamples,M.samples)}function ge(M){let _=n.get(M);return a&&M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function ut(M){let _=o.render.frame;u.get(M)!==_&&(u.set(M,_),M.update())}function Fe(M,_){let N=M.colorSpace,K=M.format,Y=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||M.format===Fl||N!==bt&&N!==un&&(Ze.getTransfer(N)===ct?a===!1?e.has("EXT_sRGB")===!0&&K===ln?(M.format=Fl,M.minFilter=Dt,M.generateMipmaps=!1):_=ca.sRGBToLinear(_):(K!==ln||Y!==di)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),_}this.allocateTextureUnit=I,this.resetTextureUnits=J,this.setTexture2D=B,this.setTexture2DArray=q,this.setTexture3D=V,this.setTextureCube=W,this.rebindTextures=Le,this.setupRenderTarget=D,this.updateRenderTargetMipmap=Ct,this.updateMultisampleRenderTarget=xe,this.setupDepthRenderbuffer=je,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=ge}function AM(i,e,t){let n=t.isWebGL2;function s(r,o=un){let a,c=Ze.getTransfer(o);if(r===di)return i.UNSIGNED_BYTE;if(r===Sp)return i.UNSIGNED_SHORT_4_4_4_4;if(r===Mp)return i.UNSIGNED_SHORT_5_5_5_1;if(r===nv)return i.BYTE;if(r===iv)return i.SHORT;if(r===gu)return i.UNSIGNED_SHORT;if(r===xp)return i.INT;if(r===ci)return i.UNSIGNED_INT;if(r===Ln)return i.FLOAT;if(r===zr)return n?i.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(r===sv)return i.ALPHA;if(r===ln)return i.RGBA;if(r===rv)return i.LUMINANCE;if(r===ov)return i.LUMINANCE_ALPHA;if(r===Vi)return i.DEPTH_COMPONENT;if(r===Os)return i.DEPTH_STENCIL;if(r===Fl)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(r===av)return i.RED;if(r===bp)return i.RED_INTEGER;if(r===cv)return i.RG;if(r===Ap)return i.RG_INTEGER;if(r===Ep)return i.RGBA_INTEGER;if(r===Qc||r===el||r===tl||r===nl)if(c===ct)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(r===Qc)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===el)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===tl)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===nl)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(r===Qc)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===el)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===tl)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===nl)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Fd||r===Bd||r===zd||r===kd)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(r===Fd)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Bd)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===zd)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===kd)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===wp)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(r===Hd||r===Vd)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(r===Hd)return c===ct?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(r===Vd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Gd||r===Wd||r===Xd||r===qd||r===Yd||r===$d||r===jd||r===Zd||r===Kd||r===Jd||r===Qd||r===ef||r===tf||r===nf)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(r===Gd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Wd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Xd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===qd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Yd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===$d)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===jd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Zd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Kd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===Jd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Qd)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===ef)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===tf)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===nf)return c===ct?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===il||r===sf||r===rf)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(r===il)return c===ct?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===sf)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===rf)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===lv||r===of||r===af||r===cf)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(r===il)return a.COMPRESSED_RED_RGTC1_EXT;if(r===of)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===af)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===cf)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Hi?n?i.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):i[r]!==void 0?i[r]:null}return{convert:s}}var Kl=class extends gt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}},Nn=class extends Nt{constructor(){super(),this.isGroup=!0,this.type="Group"}},EM={type:"move"},Fr=class{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Nn,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Nn,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new C,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new C),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Nn,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new C,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new C),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){let t=this._hand;if(t)for(let n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null,a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(let v of e.hand.values()){let p=t.getJointPose(v,n),f=this._getHandJoint(l,v);p!==null&&(f.matrix.fromArray(p.transform.matrix),f.matrix.decompose(f.position,f.rotation,f.scale),f.matrixWorldNeedsUpdate=!0,f.jointRadius=p.radius),f.visible=p!==null}let u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],d=u.position.distanceTo(h.position),m=.02,g=.005;l.inputState.pinching&&d>m+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&d<=m-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(c.matrix.fromArray(r.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,r.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(r.linearVelocity)):c.hasLinearVelocity=!1,r.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(r.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(EM)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=r!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){let n=new Nn;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}},wM=`
void main() {
